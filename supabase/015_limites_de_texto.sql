...
alter table public.avisos drop constraint if exists avisos_conteudo_tam;
alter table public.avisos   add constraint avisos_conteudo_tam    check (length(conteudo) <= 20000)   not valid;
alter table public.sprints drop constraint if exists sprints_descricao_tam;
alter table public.sprints  add constraint sprints_descricao_tam  check (length(descricao) <= 20000)  not valid;
alter table public.eventos drop constraint if exists eventos_descricao_tam;
...
alter table public.perfis drop constraint if exists perfis_nome_tam;
...
alter table public.perfis drop constraint if exists perfis_curso_tam;
