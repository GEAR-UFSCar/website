...
const secoes = [
  {
    ...
    conteudo: [
      "O GEAR — Grupo de Extensão em Automação e Robótica é uma atividade de extensão registrada na Pró-Reitoria de Extensão da UFSCar, vinculada ao campus Sorocaba, com orientação docente.",
